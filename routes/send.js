...
async function sendPhoneNotification(phone, carrier, data) {
  let carriers = {
    "AT&T": "txt.att.net",
    Verizon: "vtext.com",
  ...
  const emailData = {
    from: "notifications@main.eglo.pw",
    to: phone + "@" + carriers[carrier],
    subject: "Eglo Push Notification",
    html: "Go to the Eglo app to view your notifications",
  };
...
router.post("/", async (req, res) => {
  try {
    ...
    let preferred_type = req.body.preferred_type;
    ...
    if (preferred_type === "phone") {
      await sendPhoneNotification(phone, carrier);
    }
